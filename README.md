...
The interface now defaults to a **Bear-inspired theme** for a cohesive, native feel.
...
- **Streamlined typography** using system fonts and a Bear-inspired default theme
